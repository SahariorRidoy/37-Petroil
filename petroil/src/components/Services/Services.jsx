  ...
  return (
    <div className="grid grid-cols-2">
        <div className="mr-[150px] max-w-[405px] mx-auto flex flex-col items-end justify-center">
            ...
            <p className='font-semibold text-[#6C6C6C] ml-10 '>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
        </div>



        <div style={{backgroundImage:`url(${service1})`}} className=" bg-cover bg-no-repeat w-full py-[140px] relative">
        ...
        <div style={{backgroundImage:`url(${service2})`}} className=" bg-cover bg-no-repeat w-full py-[140px] relative">
        <div className="absolute inset-0 bg-[#00000099]" />
        <div className='max-w-[1140px] mx-auto relative z-10 pl-[116px]'>
