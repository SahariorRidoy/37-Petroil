...
export default function Banner() {
    return (
      <div style={{backgroundImage:`url(${banner})`}} className=" bg-cover bg-no-repeat w-full py-[257px] relative">
        ...
        <div className='max-w-[1140px] mx-auto text-left relative z-10'>
            <h1 className='max-w-[842px] text-white font-bold text-7xl mb-7'>We exist since 1975 on the oil and gas industry.</h1>
